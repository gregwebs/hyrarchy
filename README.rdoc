= Brokeness
This library appears to work fine on Rails2. However, the rebuild! method is broken, so you can't convert existing data to use it.
There are test failures for Rails3.
...
Hyrarchy doesn't yet awesome_nested_set's scoping feature or its view helper.
